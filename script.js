        ...
        const firebaseConfig = {
            apiKey: "YOUR_FIREBASE_API_KEY", // Replace with real key from console.firebase.google.com
        ...
        try {
            ...
            if (!firebaseConfig.apiKey || firebaseConfig.apiKey.includes("YOUR_")) {
                isDemoMode = true;
                console.warn("Blossom Auth: Placeholder keys detected. Running in Demo Mode.");
            ...
            isDemoMode = true;
            console.error("Firebase Initialization Error. Switching to Demo Mode.", err);
        }
